...
ifeq (fusion_venturi,$(TARGET_PRODUCT))

# OVERLAY_TARGET adds overlay asset source
OVERLAY_TARGET := pa_hdpi

# AOKP device overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/fusion/overlay/aokp/device/venturi
...
# vendor hack
$(call vendor-replace,samsung,venturi)

# Inherit CM device configuration
$(call inherit-product, device/samsung/venturi/cm.mk)

PRODUCT_NAME := fusion_venturi
